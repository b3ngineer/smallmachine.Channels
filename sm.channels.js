(function(sm) {
  ...
  function activator(model) {
    ...
    var defaultStorageDelegate = {update:function(message) {
    ...
    model.set.subscribe({update:function(message) {
      return defaultStorageDelegate
    }});
    var defaultValueDelegate = {update:function(message) {
      if(typeof message.key !== "undefined" && typeof message.namespace !== "undefined") {
        return function(message) {
    ...
    model.get.subscribe({update:function(message) {
